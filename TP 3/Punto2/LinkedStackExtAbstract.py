...
class LinkedStackExtAbstract(ABC):
    """Representa un conjunto de métodos para extender la implementación original de LinkedStack.
    Args:
    ...
    def replace_all(self, param1: Any, param2: Any) -> None:
        ...
        Args:
        param1 (Any): Valor a buscar/reemplazar. param2 (Any): Nuevo valor.
        """
        pass

    @abstractmethod
    def exchange(self) -> None:
        """Intercambia el elemento ubicado en el tope con el más antigüo o último. Raises:
