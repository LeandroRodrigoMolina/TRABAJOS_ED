...
class DequeAbstract(ABC):
    """ Representa una estructura de datos lineal de acceso restringido que soporta inserción y eliminación por ambos extremos.
    Args:
    ABC (_type_):
    """
    ...
    def __str__(self) -> str:
        """ Concatena en un único string todos los elementos almacenados en los nodos de la estructura.
        Returns:
    ...
    @abstractmethod
    def last(self) -> Any:
        """ Devuelve el elemento correspondiente al nodo ubicado al final de la estructura.
        Raises: 
            Exception: Arroja excepción si la estructura está vacía.
        Returns:
